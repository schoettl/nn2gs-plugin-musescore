...
function checkMuseScoreVersionSupport() {
  (4 > mscoreMajorVersion || 4 <= mscoreMajorVersion && 3 >= mscoreMinorVersion) && errorDialog.show(`Diese Version des Plugins funktioniert nur mit MuseScore 4.4 und h\u00f6her. Sie verwenden gerade MuseScore ${mscoreMajorVersion}.${mscoreMinorVersion}.`);
}
    ...
    MessageDialog {
        id: errorDialog
        title: "Fehler"
        //icon: StandardIcon.Critical // not supported in Qt 6
        function show(msg) {
            text = msg
            open()
        }
    ...
    MessageDialog {
        id: warningDialog
        title: "Warnung"
        //icon: StandardIcon.Warning // not supported in Qt 6
        function show(msg) {
            text = msg
            open()
        }
    ...
    MessageDialog {
        id: infoDialog
        title: "Info"
        //icon: StandardIcon.Information // not supported in Qt 6
