...
#+CAPTION: zu 2.: Eigenschaften von Notenzeile/Instrument anpassen durch Doppelklick auf „Steir. Harmonika“ am Anfang der Notenzeile. Violinschlüssel ausblenden, Name des Instruments und Tonumfang ändern. Der maximale Tonumfang ist von H (G-C-F-B) bis cis⁴ (B-Es-As-Des mit 50-Tasten). Noten außerhalb des Tonumfangs werden von MuseScore rot angezeigt.
#+ATTR_HTML: :width 600px
