...
- Bassbezifferung zu ausnotierten Basslinien (z.B. bei Chorälen)
  hinzufügen. Dabei kann zwischen verschiedene Basssystemen und
  Schemas für die Bassbenennung (A-H vs. A, A', …) ausgewählt werden.
